...
/**
 * A class encapsulating the [[EndpointOAuthAmazon]] resource.
 *
 * @constructor create a new EndpointOAuthAmazon.
 ...
 */
final case class EndpointOAuthAmazon(
...
object EndpointOAuthAmazon {
  implicit val encodeEndpointOAuthAmazon: io.circe.Encoder[EndpointOAuthAmazon] = io.circe.Encoder.encodeJsonObject.contramap(value =>
    List(
  ...
  implicit val decodeEndpointOAuthAmazon: io.circe.Decoder[EndpointOAuthAmazon] = (c: io.circe.HCursor) => for {
