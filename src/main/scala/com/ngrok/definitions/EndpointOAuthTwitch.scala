...
/**
 * A class encapsulating the [[EndpointOAuthTwitch]] resource.
 *
 * @constructor create a new EndpointOAuthTwitch.
 ...
 */
final case class EndpointOAuthTwitch(
...
object EndpointOAuthTwitch {
  implicit val encodeEndpointOAuthTwitch: io.circe.Encoder[EndpointOAuthTwitch] = io.circe.Encoder.encodeJsonObject.contramap(value =>
    List(
  ...
  implicit val decodeEndpointOAuthTwitch: io.circe.Decoder[EndpointOAuthTwitch] = (c: io.circe.HCursor) => for {
