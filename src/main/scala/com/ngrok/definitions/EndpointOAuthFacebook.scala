...
/** A class encapsulating the [[EndpointOAuthFacebook]] resource.
  *
  * @constructor create a new EndpointOAuthFacebook.
  ...
  */
final case class EndpointOAuthFacebook(
...
object EndpointOAuthFacebook {
  implicit val encodeEndpointOAuthFacebook: io.circe.Encoder[EndpointOAuthFacebook] =
  ...
  implicit val decodeEndpointOAuthFacebook: io.circe.Decoder[EndpointOAuthFacebook] = (c: io.circe.HCursor) =>
    for {
